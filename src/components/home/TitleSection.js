  ...
  return (
    <div className={styles.titleContainer}>
      ...
      <p>
        ...
        европейския пазар! Нашата основна дейност е автомобилният международен
        транспорт на стоки и товари. Вярваме, че предлаганите висококачествени
        услуги, индивидуалният подход, както и бързите гъвкави решения в
        комбинация с дългогодишният ни опит, са нещата които ни отличават от
        повечето наши конкуренти. В основата зад всичко стоят всички наши
        служители. Днес Класик 2000 ООД си сътрудничи успешно с водещите
        български и международни компании в транспортната логистика и спедиция.
      </p>
    </div>
  );
};
